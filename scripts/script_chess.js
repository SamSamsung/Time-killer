...
for(i=0; i<8; i++){
    for(j=0; j<8;j++){
        ...
        hint.className = "hint"
        hint.setAttribute("onclick", "return false;");
...
window.onclick = function(e) {
    console.log(e.path[0].classList, parseInt(e.path[0].id))
    click(e.path[0].classList, parseInt(e.path[0].id))
}
function click(classes, id){
    ...
    if (x.length > 0){
        for(j = x.length-1; j > -1; j-- ){
            document.getElementsByClassName("active")[j].classList.remove("active");
        }
    }

    if(document.getElementById(id).querySelector("span").classList > 0){
        if(document.getElementById(id).querySelector("span").classList[0] == "show"){
            play(classes, id)
        } else{
            eat(classes, id)
        }
        ...
        if(classes[3] == "white_king" || classes[3] == "black_king"){
            if(0 <= id+1 && id+1 <= 63 && (Math.floor((id+1)/8) == Math.floor(id/8))){
                if(document.getElementById(id+1).classList.length < 3){
                    document.getElementById(id+1).querySelector("span").classList.add("show")
                } else if(bool_eat(1, id)){
                    document.getElementById(id+1).querySelector("span").classList.add("active")
                }
            }
            if(0 <= id-1 && id-1 <= 63 && (Math.floor((id-1)/8) == Math.floor(id/8))){
                if(document.getElementById(id-1).classList.length < 3){
            ...
            if(0 <= id+8 && id+8 <= 63 && (Math.floor((id+8)/8) == Math.floor(id/8)+1)){
                if(document.getElementById(id+8).classList.length < 3){
                    document.getElementById(id+8).querySelector("span").classList.add("show")
                }else if(bool_eat(8, id)){
                    document.getElementById(id+8).querySelector("span").classList.add("active")
                }
            }
            if(0 <= id-8 && id-8 <= 63 && (Math.floor((id-8)/8) == Math.floor(id/8)-1)){
                if(document.getElementById(id-8).classList.length < 3){
                ...
                if(document.getElementById(id+7).classList.length < 3){
                    document.getElementById(id+7).querySelector("span").classList.add("show")
                } else if(bool_eat(7, id)){
                    document.getElementById(id+7).querySelector("span").classList.add("active")
                }
            }
            if(0 <= id-7 && id-7 <= 63 && (Math.floor((id-7)/8) == Math.floor(id/8)-1)){
                if(document.getElementById(id-7).classList.length < 3){
            ...
            if(0 <= id+9 && id+9 <= 63 && (Math.floor((id+9)/8) == Math.floor(id/8)+1)){
                if(document.getElementById(id+9).classList.length < 3){
                    document.getElementById(id+9).querySelector("span").classList.add("show")
                } else if(bool_eat(9, id)){
                    document.getElementById(id+9).querySelector("span").classList.add("active")
                }
            }
            ...
            /* A gérer: Les diagonales et le fait de ne pas aller tout a droite quand le pion est collé a gauche*/
            if(id <= 55 && document.getElementById(id-8).classList.length < 3 && document.getElementById(id-16).classList.length < 3){
                document.getElementById(id-8).querySelector("span").classList.add("show")
                document.getElementById(id-16).querySelector("span").classList.add("show")
            if((Math.floor((id-9)/8) == Math.floor(id/8)-1) || (Math.floor((id-7)/8) == Math.floor(id/8)-1)){
                if(bool_eat(-7, id)){
                    document.getElementById(id-7).querySelector("span").classList.add("active")
                } if (bool_eat(-9, id)){
                    document.getElementById(id-9).querySelector("span").classList.add("active")
            ...
            if(0 <= id+10 && id+10 <= 63 && Math.floor((id+11)/ 8) == Math.floor(id/8)+1){
                if(document.getElementById(id+10).classList.length < 3){
                    document.getElementById(id+10).querySelector("span").classList.add("show")
                }
            }
            ...
            if(0 <= id+6 && id+6 <= 63 && (Math.floor((id+6)/ 8) == Math.floor(id/8)+1)){
                if(document.getElementById(id+6).classList.length < 3){
                    document.getElementById(id+6).querySelector("span").classList.add("show")
                }
            }
            if(0 <= id-6 && id-6 <= 63 && (Math.floor((id-6)/ 8) == Math.floor(id/8)-1)){
                if(document.getElementById(id-6).classList.length < 3){
                ...
                if(document.getElementById(id+15).classList.length < 3){
                    document.getElementById(id+15).querySelector("span").classList.add("show")
                }
            }
            if(0 <= id-15 && id-15 <= 63 && (Math.floor((id-15)/ 8) == Math.floor(id/8)-2)){
                if(document.getElementById(id-15).classList.length < 3){
                ...
                if(document.getElementById(id+17).classList.length < 3){
                    document.getElementById(id+17).querySelector("span").classList.add("show")
                }
            }
            if(0 <= id-17 && id-17 <= 63 && (Math.floor((id-17)/ 8) == Math.floor(id/8)-2)){
                if(document.getElementById(id-17).classList.length < 3){
            ...
            while(0 <= id - cpt_h_d && document.getElementById(id-cpt_h_d).classList.length == 2 && (Math.floor((id-cpt_h_d)/ 8) == Math.floor(id/8)-(cpt_h_d/7))){
                document.getElementById(id-cpt_h_d).querySelector("span").classList.add("show")
                cpt_h_d = cpt_h_d + 7;
                
            }
            if((id-cpt_h_d >= 0) && (Math.floor((id-cpt_h_d)/ 8) == Math.floor(id/8)-(cpt_h_d/7)) && bool_eat(-cpt_h_d, id)){
                document.getElementById(id-cpt_h_d).querySelector("span").classList.add("active")
            ...
            while(0 <= id-cpt_h_g && document.getElementById(id-cpt_h_g).classList.length == 2 && (Math.floor((id-cpt_h_g)/ 8) == Math.floor(id/8)-(cpt_h_g/9))){
                document.getElementById(id-cpt_h_g).querySelector("span").classList.add("show")
                cpt_h_g = cpt_h_g + 9;
            } if((id-cpt_h_g >= 0) && (Math.floor((id-cpt_h_g)/ 8) == Math.floor(id/8)-(cpt_h_g/9)) && bool_eat(-cpt_h_g, id)){
                document.getElementById(id-cpt_h_g).querySelector("span").classList.add("active")
            ...
            while(id + cpt_b_d <= 63 && document.getElementById(id+cpt_b_d).classList.length == 2 && (Math.floor((id+cpt_b_d)/ 8) == Math.floor(id/8)+(cpt_b_d/9))){
                document.getElementById(id+cpt_b_d).querySelector("span").classList.add("show")
                cpt_b_d = cpt_b_d + 9;
            } if((id+cpt_b_d <= 63) && (Math.floor((id+cpt_b_d)/ 8) == Math.floor(id/8)+(cpt_b_d/9)) && bool_eat(cpt_b_d, id)){
                document.getElementById(id+cpt_b_d).querySelector("span").classList.add("active")
            ...
            while(id + cpt_b_g <= 63 && document.getElementById(id+cpt_b_g).classList.length == 2 && (Math.floor((id+cpt_b_g)/ 8) == Math.floor(id/8)+(cpt_b_g/7))){
                document.getElementById(id+cpt_b_g).querySelector("span").classList.add("show")
                cpt_b_g = cpt_b_g + 7;
            }if((id+cpt_b_g <= 63) && (Math.floor((id+cpt_b_g)/ 8) == Math.floor(id/8)+(cpt_b_g/7)) && bool_eat(cpt_b_g, id)){
                document.getElementById(id+cpt_b_g).querySelector("span").classList.add("active")
